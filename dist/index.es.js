...
import {
  ...
  markRaw as X,
  toRaw as ft,
  hasInjectionContext as je,
  inject as Rt,
  getCurrentInstance as ze,
  watch as jt,
  unref as S,
  reactive as He,
  isRef as ht,
  ...
  nextTick as Bt,
  computed as Ht,
  getCurrentScope as Fe,
  onScopeDispose as Ue,
  toRefs as Vt,
  ...
  onBeforeMount as ue,
  createTextVNode as de,
  watchEffect as Be,
  withDirectives as Wt,
  vModelText as We,
  vModelSelect as Je,
} from "vue";
var pe = !1;
...
const Ke = typeof Proxy == "function",
  Xe = "devtools-plugin:setup",
  ...
  return (
    nt !== void 0 ||
      (typeof window < "u" && window.performance
        ? ((nt = !0), (Mt = window.performance))
        : typeof globalThis < "u" &&
            !((e = globalThis.perf_hooks) === null || e === void 0) &&
            e.performance
          ? ((nt = !0), (Mt = globalThis.perf_hooks.performance))
          : (nt = !1)),
    nt
  );
}
...
function he(e, t) {
  const n = e,
    s = fe(),
    o = Ye(),
    i = Ke && n.enableEarlyProxy;
  if (o && (s.__VUE_DEVTOOLS_PLUGIN_API_AVAILABLE__ || !i)) o.emit(Xe, e, t);
  else {
...
const At = typeof navigator == "object" ? navigator : { userAgent: "" },
  _e =
    /Macintosh/.test(At.userAgent) &&
    /AppleWebKit/.test(At.userAgent) &&
    !/Safari/.test(At.userAgent),
  be = Z
...
function rs(e, t, n, s) {
  ...
  const o = e.type === "application/octet-stream",
    i = /constructor/i.test(String(Jt.HTMLElement)) || "safari" in Jt,
  ...
  if ((r || (o && i) || _e) && typeof FileReader < "u") {
    ...
    (a.onloadend = function () {
      ...
      (c = r ? c : c.replace(/^data:[^;]*;/, "data:attachment/file;")),
    ...
    s ? s.location.assign(a) : (location.href = a),
      (s = null),
      setTimeout(function () {
  ...
  if (!ve())
    try {
      await navigator.clipboard.writeText(JSON.stringify(e.state.value)),
        $("Global state copied to clipboard.");
    } catch (t) {
      if (ye(t)) return;
      $(
...
async function cs(e) {
  if (!ve())
    try {
      we(e, JSON.parse(await navigator.clipboard.readText())),
        $("Global state pasted from clipboard.");
    } catch (t) {
      if (ye(t)) return;
      $(
      ...
      typeof n.now != "function" &&
              ...
              action: (s) => {
                ...
                o
                  ? typeof o.$reset != "function"
                    ? $(
                        `Cannot reset "${s}" store because it doesn't have a "$reset" method implemented.`,
                        "warn",
                      )
                    : (o.$reset(), $(`Store "${s}" reset.`))
                  : $(
                      `Cannot reset "${s}" store because it wasn't found.`,
                      "warn",
                    );
              },
            },
            ...
            (o = o.concat(Array.from(t._s.values()))),
              (s.rootNodes = (
                s.filter
                  ? o.filter((i) =>
                      "$id" in i
                        ? i.$id.toLowerCase().includes(s.filter.toLowerCase())
                        : Ae.toLowerCase().includes(s.filter.toLowerCase()),
                    )
                  : o
              ).map(ps));
          }
        ...
        n.on.getInspectorState((s) => {
          if (s.app === e && s.inspectorId === Q) {
            ...
            if (!o) return;
            o &&
              (s.nodeId !== Tt && (globalThis.$store = ft(o)),
              (s.state = fs(o)));
          }
        }),
        n.on.editInspectorState((s, o) => {
          if (s.app === e && s.inspectorId === Q) {
            ...
            if (!i) return $(`store "${s.nodeId}" not found`, "error");
            const { path: r } = s;
            Ut(i)
              ? r.unshift("state")
              : (r.length !== 1 ||
                  !i._customProperties.has(r[0]) ||
                  r[0] in i.$state) &&
                r.unshift("$state"),
              (it = !1),
              s.set(i, r, s.state.value),
              (it = !0);
          }
        }),
        n.on.editComponentState((s) => {
          if (s.type.startsWith("🍍")) {
            const o = s.type.replace(/^🍍\s*/, ""),
              i = t._s.get(o);
            if (!i) return $(`store "${o}" not found`, "error");
            const { path: r } = s;
            if (r[0] !== "state")
...
function bs(e, t) {
  St.includes(xt(t.$id)) || St.push(xt(t.$id)),
    he(
      {
        id: "dev.esm.pinia",
        label: "Pinia 🍍",
      ...
      (n) => {
          ...
          t.$subscribe(
            ({ events: r, type: a }, c) => {
              ...
              a === F.patchFunction
                ...
                : a === F.patchObject
                  ? (l.subtitle = "🧩")
                  : r && !Array.isArray(r) && (l.subtitle = r.type),
                r &&
                  (l.data["rawEvent(s)"] = {
                    _custom: {
        ...
        (t.$dispose = () => {
          ...
          n.sendInspectorTree(Q),
          n.sendInspectorState(Q),
          n.getSettings().logStoreChanges && $(`"${t.$id}" store installed 🆕`);
      },
    );
}
let Te = 0,
    ...
    if (((t._isOptionsAPI = !!n.state), !t._p._testing)) {
      ...
      ft(t)._hotUpdate = function (o) {
        s.apply(this, arguments),
          Yt(t, Object.keys(o._hmrPayload.actions), !!t._isOptionsAPI);
      };
    }
    bs(
      e,
...
function qt(e, t) {
  ...
  for (const n in t) {
    ...
    const s = t[n],
      o = e[n];
    tt(o) && tt(s) && e.hasOwnProperty(n) && !ht(s) && !zt(s)
      ? (e[n] = qt(o, s))
      : (e[n] = s);
  }
  return e;
...
function te(e, t, n, s) {
  const { state: o, actions: i, getters: r } = t,
    a = n.state.value[e];
  let c;
  function l() {
    !a &&
      ...
      Object.keys(r || {}).reduce(
        (f, _) => (
          process.env.NODE_ENV !== "production" &&
            _ in d &&
            console.warn(
              `[🍍]: A getter cannot have the same name as another state property. Rename one of them. Found with "${_}" in store "${e}".`,
            ),
          (f[_] = X(
            Ht(() => {
              mt(n);
...
function Pt(e, t, n = {}, s, o, i) {
  ...
  const x = (h, p = "") => {
      ...
      const T = function () {
        ...
        return ut instanceof Promise
          ? ut
              .then((P) => (ot(lt, P), P))
              .catch((P) => (ot(Ct, P), Promise.reject(P)))
          : (ot(lt, ut), ut);
      };
  ...
  s._s.set(e, b);
  const J = ((s._a && s._a.runWithContext) || ws)(() =>
    s._e.run(() => (r = ae()).run(() => t({ action: x }))),
  );
  for (const h in J) {
    const p = J[h];
    if ((ht(p) && !Zt(p)) || zt(p))
      process.env.NODE_ENV !== "production" && o
        ? vt(ct.value, h, Dt(J, h))
        : i ||
          (N && Ts(p) && (ht(p) ? (p.value = N[h]) : qt(p, N[h])),
          (s.state.value[e][h] = p)),
        process.env.NODE_ENV !== "production" && R.state.push(h);
    else if (typeof p == "function") {
      const T = process.env.NODE_ENV !== "production" && o ? p : x(p, h);
      (J[h] = T),
        process.env.NODE_ENV !== "production" && (R.actions[h] = p),
        (a.actions[h] = p);
    } else
      process.env.NODE_ENV !== "production" &&
        Zt(p) &&
        ...
        Z &&
          (
            J._getters || // @ts-expect-error: same
            (J._getters = X([]))
          ).push(h));
  }
  if (
    ...
    process.env.NODE_ENV !== "production" &&
      (b._hotUpdate = X((h) => {
        (b._hotUpdating = !0),
          h._hmrPayload.state.forEach((p) => {
            if (p in b.$state) {
              const T = h.$state[p],
                q = b.$state[p];
              typeof T == "object" && tt(T) && tt(q)
                ? Se(T, q)
                : (h.$state[p] = q);
            }
            vt(b, p, Dt(h.$state, p));
          ...
          (l = !1),
          (d = !1),
          (s.state.value[e] = Dt(h._hmrPayload, "hotState")),
          (d = !0),
          Bt().then(() => {
            l = !0;
          });
        ...
        for (const p in h._hmrPayload.getters) {
          const T = h._hmrPayload.getters[p],
            q = i
        ...
        Object.keys(b._hmrPayload.getters).forEach((p) => {
          ...
          (b._hmrPayload = h._hmrPayload),
          (b._getters = h._getters),
          (b._hotUpdating = !1);
      })),
    process.env.NODE_ENV !== "production" &&
      process.env.NODE_ENV !== "test" &&
  ...
  return (
    s._p.forEach((h) => {
      if (
        ...
        Object.keys(p || {}).forEach((T) => b._customProperties.add(T)),
          I(b, p);
      } else
        I(
          b,
    ...
    process.env.NODE_ENV !== "production" &&
      ...
      typeof b.$state.constructor == "function" &&
      !b.$state.constructor.toString().includes("[native code]") &&
      console.warn(`[🍍]: The "state" must be a plain object. It cannot be
	state: () => new MyClass()
Found in store "${b.$id}".`),
    N && i && n.hydrate && n.hydrate(b.$state, N),
    (l = !0),
    (d = !0),
    b
  );
...
function Ss(e, t, n) {
  ...
  function r(a, c) {
    const l = je();
    if (
      ((a = // in test mode, ignore the argument provided as we can always retrieve a
        // pinia instance with getActivePinia()
        (process.env.NODE_ENV === "test" && pt && pt._testing ? null : a) ||
        (l ? Rt(me, null) : null)),
      a && mt(a),
...
This will fail in production.`);
    (a = pt),
      a._s.has(s) ||
        (i ? Pt(s, t, o, a) : te(s, o, a),
        process.env.NODE_ENV !== "production" && (r._pinia = a));
    const d = a._s.get(s);
    if (process.env.NODE_ENV !== "production" && c) {
      const f = "__hot:" + s,
        _ = i ? Pt(f, t, o, a, !0) : te(f, I({}, o), a, !0);
    ...
    if (process.env.NODE_ENV !== "production" && Z) {
      ...
      if (
        f &&
        f.proxy && // avoid adding stores that are just built for hot module replacement
        !c
      ) {
        const _ = f.proxy,
          y = "_pStores" in _ ? _._pStores : (_._pStores = {});
        y[s] = d;
      }
    }
    return d;
...
const xs = ["id", "checked"],
  ...
  Ds = /* @__PURE__ */ z(Cs, [["__scopeId", "data-v-fdbfedc6"]]),
  $s = ["disabled"],
  ks = /* @__PURE__ */ M({
    __name: "MCQButton",
    props: {
    ...
    setup(e, { emit: t }) {
      const n = E("skip"),
        ...
        i = (c, l) => {
          !c && l
            ? r("next", "Next", "submitAnswer")
            : c && l
              ? r("skip", "Skip", "nextQuestion")
              : !c && !l && r("skip", "Skip", "skipQuestion");
        },
        r = (c, l, d) => {
  ...
  Ns = /* @__PURE__ */ z(ks, [["__scopeId", "data-v-847b8dd5"]]),
  Qs = /* @__PURE__ */ M({
    __name: "NextButton",
    props: {
      buttonName: {},
...
var A = ((e) => (
    (e[(e.New = 0)] = "New"),
    (e[(e.Learning = 1)] = "Learning"),
    (e[(e.Review = 2)] = "Review"),
    (e[(e.Relearning = 3)] = "Relearning"),
    e
  ))(A || {}),
  u = ((e) => (
    (e[(e.Manual = 0)] = "Manual"),
...
class v {
  static card(t) {
    return {
      ...t,
      state: v.state(t.state),
      due: v.time(t.due),
      last_review: t.last_review ? v.time(t.last_review) : void 0,
    };
  }
  static rating(t) {
    if (typeof t == "string") {
  ...
  static review_log(t) {
    return {
      ...t,
      due: v.time(t.due),
      rating: v.rating(t.rating),
      state: v.state(t.state),
      review: v.time(t.review),
    };
  }
}
const Os = 0.9,
    ...
    return (
      e != null &&
        ...
        (e.w.length === 19
          ? (t = e == null ? void 0 : e.w)
          : e.w.length === 17 &&
            ((t = e == null ? void 0 : e.w.concat([0, 0])),
            console.debug("[FSRS V5]auto fill w to 19 length"))),
      {
        request_retention: (e == null ? void 0 : e.request_retention) || Os,
        maximum_interval: (e == null ? void 0 : e.maximum_interval) || Vs,
        w: t,
        enable_fuzz: (e == null ? void 0 : e.enable_fuzz) ?? qs,
        enable_short_term: (e == null ? void 0 : e.enable_short_term) ?? Ps,
      }
    );
  };
...
function Ee(e, t, n) {
  return new Date(
    n
      ? et(e).getTime() + t * 24 * 60 * 60 * 1e3
      : et(e).getTime() + t * 60 * 1e3,
  );
}
function Is(e, t, n) {
...
const Nt = [60, 60, 24, 31, 12],
  Qt = ["second", "min", "hour", "day", "month", "year"];
...
class Gs {
  constructor(t) {
    ...
    O(this, "_seed");
    (this.param = new Proxy(It(t), this.params_handler_proxy())),
    ...
    return {
      set: function (n, s, o) {
        return (
          s === "request_retention" &&
            Number.isFinite(o) &&
            (t.intervalModifier = t.calculate_interval_modifier(Number(o))),
          Reflect.set(n, s, o),
          !0
        );
      },
  ...
  apply_fuzz(t, n, s) {
    ...
    const o = Us(this.seed)(),
      { min_ivl: i, max_ivl: r } = zs(t, n, this.param.maximum_interval);
  ...
  next_difficulty(t, n) {
    ...
    return this.constrain_difficulty(
      this.mean_reversion(this.init_difficulty(u.Easy), s),
    );
  }
  ...
  next_recall_stability(t, n, s, o) {
    const i = u.Hard === o ? this.param.w[15] : 1,
      r = u.Easy === o ? this.param.w[16] : 1;
    return +(
      n *
      (1 +
...
class Ce {
  constructor(t, n, s) {
    ...
    (this.algorithm = s),
      (this.last = v.card(t)),
      (this.current = v.card(t)),
      (this.review_time = v.time(n)),
      this.init();
  }
  init() {
    const { state: t, last_review: n } = this.current;
    let s = 0;
    t !== A.New && n && (s = this.review_time.diff(n, "days")),
  ...
  initSeed() {
    const t = this.review_time.getTime(),
      n = this.current.reps,
      s = this.current.difficulty * this.current.stability;
...
class oe extends Ce {
  newState(t) {
    ...
    switch (
      ((s.difficulty = this.algorithm.init_difficulty(t)),
      (s.stability = this.algorithm.init_stability(t)),
      t)
    ) {
      case u.Again:
        (s.scheduled_days = 0),
          (s.due = this.review_time.scheduler(1)),
          (s.state = A.Learning);
        break;
      case u.Hard:
        (s.scheduled_days = 0),
          (s.due = this.review_time.scheduler(5)),
          (s.state = A.Learning);
        break;
      case u.Good:
        (s.scheduled_days = 0),
          (s.due = this.review_time.scheduler(10)),
          (s.state = A.Learning);
        break;
      case u.Easy: {
        const i = this.algorithm.next_interval(
          s.stability,
          this.current.elapsed_days,
          this.algorithm.parameters.enable_fuzz,
        );
        (s.scheduled_days = i),
          (s.due = this.review_time.scheduler(i, !0)),
          (s.state = A.Review);
        break;
      }
      default:
  ...
  learningState(t) {
    const n = this.next.get(t);
    if (n) return n;
    const { state: s, difficulty: o, stability: i } = this.last,
      r = v.card(this.current),
      a = this.current.elapsed_days;
    switch (
      ((r.difficulty = this.algorithm.next_difficulty(o, t)),
      (r.stability = this.algorithm.next_short_term_stability(i, t)),
      t)
    ) {
      case u.Again: {
        (r.scheduled_days = 0),
          (r.due = this.review_time.scheduler(5, !1)),
          (r.state = s);
        break;
      }
      case u.Hard: {
        (r.scheduled_days = 0),
          (r.due = this.review_time.scheduler(10)),
          (r.state = s);
        break;
      }
      case u.Good: {
        ...
        (r.scheduled_days = l),
          (r.due = this.review_time.scheduler(l, !0)),
          (r.state = A.Review);
        break;
      }
      case u.Easy: {
        const l = this.algorithm.next_short_term_stability(i, u.Good),
          d = this.algorithm.next_interval(l, a),
          f = Math.max(this.algorithm.next_interval(r.stability, a), d + 1);
        (r.scheduled_days = f),
          (r.due = this.review_time.scheduler(f, !0)),
          (r.state = A.Review);
        break;
      }
      default:
  ...
  reviewState(t) {
    const n = this.next.get(t);
    if (n) return n;
    const s = this.current.elapsed_days,
      { difficulty: o, stability: i } = this.last,
      r = this.algorithm.forgetting_curve(s, i),
      a = v.card(this.current),
      c = v.card(this.current),
      l = v.card(this.current),
      d = v.card(this.current);
    this.next_ds(a, c, l, d, o, i, r),
      this.next_interval(a, c, l, d, s),
      this.next_state(a, c, l, d),
      (a.lapses += 1);
    const f = { card: a, log: this.buildLog(u.Again) },
      _ = { card: c, log: super.buildLog(u.Hard) },
      y = { card: l, log: super.buildLog(u.Good) },
      N = { card: d, log: super.buildLog(u.Easy) };
    return (
      this.next.set(u.Again, f),
      this.next.set(u.Hard, _),
      this.next.set(u.Good, y),
      this.next.set(u.Easy, N),
      this.next.get(t)
    );
  }
  next_ds(t, n, s, o, i, r, a) {
    (t.difficulty = this.algorithm.next_difficulty(i, u.Again)),
      (t.stability = this.algorithm.next_forget_stability(i, r, a)),
      (n.difficulty = this.algorithm.next_difficulty(i, u.Hard)),
      (n.stability = this.algorithm.next_recall_stability(i, r, a, u.Hard)),
      (s.difficulty = this.algorithm.next_difficulty(i, u.Good)),
      (s.stability = this.algorithm.next_recall_stability(i, r, a, u.Good)),
      (o.difficulty = this.algorithm.next_difficulty(i, u.Easy)),
      (o.stability = this.algorithm.next_recall_stability(i, r, a, u.Easy));
  }
  next_interval(t, n, s, o, i) {
    let r, a;
    (r = this.algorithm.next_interval(n.stability, i)),
      (a = this.algorithm.next_interval(s.stability, i)),
      (r = Math.min(r, a)),
      (a = Math.max(a, r + 1));
    ...
    (t.scheduled_days = 0),
      ...
      (n.scheduled_days = r),
      (n.due = this.review_time.scheduler(r, !0)),
      (s.scheduled_days = a),
      (s.due = this.review_time.scheduler(a, !0)),
      (o.scheduled_days = c),
      (o.due = this.review_time.scheduler(c, !0));
  }
  next_state(t, n, s, o) {
    (t.state = A.Relearning),
      (n.state = A.Review),
      (s.state = A.Review),
      (o.state = A.Review);
  }
...
class ie extends Ce {
  newState(t) {
    ...
    const s = v.card(this.current),
      o = v.card(this.current),
      i = v.card(this.current),
      r = v.card(this.current);
    return (
      this.init_ds(s, o, i, r),
      this.next_interval(s, o, i, r, 0),
      this.next_state(s, o, i, r),
      this.update_next(s, o, i, r),
      this.next.get(t)
    );
  }
  init_ds(t, n, s, o) {
    (t.difficulty = this.algorithm.init_difficulty(u.Again)),
      (t.stability = this.algorithm.init_stability(u.Again)),
      (n.difficulty = this.algorithm.init_difficulty(u.Hard)),
      (n.stability = this.algorithm.init_stability(u.Hard)),
      (s.difficulty = this.algorithm.init_difficulty(u.Good)),
      (s.stability = this.algorithm.init_stability(u.Good)),
      (o.difficulty = this.algorithm.init_difficulty(u.Easy)),
      (o.stability = this.algorithm.init_stability(u.Easy));
  }
  learningState(t) {
  ...
  next_interval(t, n, s, o, i) {
    let r, a, c, l;
    (r = this.algorithm.next_interval(t.stability, i)),
      (a = this.algorithm.next_interval(n.stability, i)),
      (c = this.algorithm.next_interval(s.stability, i)),
      (l = this.algorithm.next_interval(o.stability, i)),
      (r = Math.min(r, a)),
      (a = Math.max(a, r + 1)),
      (c = Math.max(c, a + 1)),
      (l = Math.max(l, c + 1)),
      (t.scheduled_days = r),
      (t.due = this.review_time.scheduler(r, !0)),
      (n.scheduled_days = a),
      (n.due = this.review_time.scheduler(a, !0)),
      (s.scheduled_days = c),
      (s.due = this.review_time.scheduler(c, !0)),
      (o.scheduled_days = l),
      (o.due = this.review_time.scheduler(l, !0));
  }
  next_state(t, n, s, o) {
    (t.state = A.Review),
      (n.state = A.Review),
  ...
  update_next(t, n, s, o) {
    const i = { card: t, log: this.buildLog(u.Again) },
      r = { card: n, log: super.buildLog(u.Hard) },
      a = { card: s, log: super.buildLog(u.Good) },
      c = { card: o, log: super.buildLog(u.Easy) };
    this.next.set(u.Again, i),
      this.next.set(u.Hard, r),
      this.next.set(u.Good, a),
      this.next.set(u.Easy, c);
  }
}
class Bs extends Gs {
  constructor(n) {
  ...
  params_handler_proxy() {
    ...
    return {
      set: function (s, o, i) {
        return (
          o === "request_retention" && Number.isFinite(i)
            ? (n.intervalModifier = n.calculate_interval_modifier(Number(i)))
            : o === "enable_short_term" && (n.Schduler = i === !0 ? oe : ie),
          Reflect.set(s, o, i),
          !0
        );
      },
  ...
  repeat(n, s, o) {
    const i = this.Schduler,
      r = new i(n, s, this).preview();
  ...
  get_retrievability(n, s, o = !0) {
    ...
    const r = Math.max(s.diff(i.last_review, "days"), 0),
      a = this.forgetting_curve(r, +i.stability.toFixed(2));
    return o ? `${(a * 100).toFixed(2)}%` : a;
  }
  rollback(n, s, o) {
    const i = v.card(n),
      r = v.review_log(s);
    if (r.rating === u.Manual)
    ...
    switch (r.state) {
      ...
      case A.Review:
        (a = r.review),
          (c = r.due),
          (l =
            i.lapses - (r.rating === u.Again && r.state === A.Review ? 1 : 0));
        break;
    }
    const d = {
      ...i,
      ...
      elapsed_days: r.last_elapsed_days,
      scheduled_days: r.scheduled_days,
      reps: Math.max(0, i.reps - 1),
      lapses: Math.max(0, l),
      state: r.state,
      last_review: c,
    };
  ...
  forget(n, s, o = !1, i) {
    ...
    const a = r.state === A.New ? 0 : s.diff(r.last_review, "days"),
      c = {
        ...
        difficulty: r.difficulty,
        elapsed_days: 0,
        last_elapsed_days: r.elapsed_days,
        scheduled_days: a,
        review: s,
      },
      l = {
  ...
  reschedule(n, s = {}) {
    ...
    for (const i of n) {
      ...
      const r = Math.floor(i.scheduled_days),
        a = this.next_interval(
          +i.stability.toFixed(2),
          Math.round(i.elapsed_days),
          s.enable_fuzz ?? !0,
        );
      if (a === r || a === 0) continue;
      const c = { ...i };
      ...
      s.dateHandler && typeof s.dateHandler == "function"
        ? (c.due = s.dateHandler(l))
        : (c.due = l),
        o.push(c);
    }
    return o;
  ...
  Ks = (e) => ({
    ...
    elapsed_days: Math.floor(
      (/* @__PURE__ */ new Date().getTime() -
        new Date(e.lastAttempted).getTime()) /
        (1e3 * 60 * 60 * 24),
...
function Xs(e) {
  const t = /* @__PURE__ */ new Date(),
    n = Ks(e),
    s = Ys.repeat(n, t),
    o = e.correctAttempts / (e.attempts + 0.1) > 0.5 ? u.Good : u.Again,
    { card: i } = s[o];
  return {
    ...i,
    reviewDue: i.due,
...
const Zs = (e) =>
  ...
  tn = (e) =>
    Zs(e).sort((t, n) => t.reviewDue.getTime() - n.reviewDue.getTime()),
  en = (e) => {
    ...
    (s, o) => (
      Object.keys(o).forEach((i) => {
        i.trim() !== "" &&
          ...
          o[i].forEach((a) => s[i].add(a)));
      }),
      s
    ),
    {},
  );
  return Object.keys(t).reduce((s, o) => ((s[o] = [...t[o]]), s), {});
}
function Gt(e, t) {
  return e.filter((n) =>
    Object.keys(t).every((s) => {
      ...
      const o = n.tags[s];
      if (o) return o.some((i) => t[s].includes(i));
    }),
  );
}
function nn(e, t, n) {
...
function on(e, t, n) {
  ...
  for (let o = 0; o < s.length; o++) if (s[o].optionValue === n) return o;
}
const $e = (e, t) =>
    t.findIndex((n) => {
      var s;
  ...
  U = Ss("questionsQueue", {
    ...
    actions: {
      ...
      modifySelectedTags(e, { category: t, topic: n }) {
        this.selectedTags[t] &&
          (this.selectedTags[t] = e
            ? [...this.selectedTags[t], n]
            : this.selectedTags[t].filter((s) => s !== n));
      },
      initialiseQuiz(e, t) {
        (this.questionsQueue = e),
          (this.questionsStack = []),
          (this.quizMode = t),
          (this.quizStats = e.map((n) => ({
            question: n,
            correct: 0,
            skipped: 0,
            attempts: 0,
      ...
      incrementStat(e, t, n) {
        ...
        if (this.quizStats[s]) {
          if (n !== void 0) {
            ...
            const o = this.quizStats[s].question.optionsList
              .map((i) => i.optionCorrect)
              .indexOf(!0);
            Number(n) === Number(o)
              ? (this.quizStats[s].correct = 1)
              : (this.quizStats[s].correct = 0);
          }
          this.quizStats[s].selectedValue =
            n !== void 0
              ? this.quizStats[s].question.optionsList[Number(n)].optionValue
              : "";
        }
      },
  ...
  un = /* @__PURE__ */ M({
    ...
    setup(e, { emit: t }) {
      const n = U(),
        ...
        f = (C) => n.incrementStat(C.$oid, "attempts", s.value ?? void 0),
        _ = () => {
      ...
      function _t(C, D) {
        const x = $e(C.$oid, n.quizStats),
          R = n.quizStats[x].selectedValue,
          st = on(n.quizStats, x, R);
        return String(st) === D ? ((s.value = D), "selected") : "";
      }
      function bt(C, D) {
        const x = D[parseInt(C)],
          R = s.value === C;
        return o.value
          ? x.optionCorrect
          ...
          [
            ...
            m("div", ln, [
              S(n).quizMode === "Timed"
                ? (g(),
                  H(
                    ee,
                    {
                      key: 0,
                      "button-name":
                        S(n).questionsQueue.length >= 1 ? "→" : "Submit",
                ...
                : V("", !0),
              S(n).quizMode === "Timed" && S(n).questionsStack.length > 1
                ? (g(),
                  H(ee, {
                    key: 1,
                    "button-name": "←",
  ...
  ke = /* @__PURE__ */ z(un, [["__scopeId", "data-v-181a554c"]]),
  dn = (e) => (ce("data-v-38adb08e"), (e = e()), le(), e),
  pn = { class: "report-container" },
  fn = { class: "mcq-report" },
  hn = { class: "table-container" },
  mn = /* @__PURE__ */ dn(() =>
    /* @__PURE__ */ m(
      "thead",
      null,
  ...
  Sn = /* @__PURE__ */ M({
    __name: "MCQStatus",
    setup(e) {
      const t = Rt("$updateQAttemptCallback") ?? qe,
        n = U(),
        s = n.quizStats,
        o = n.quizStats.length,
        i = s.filter((c) => c.correct === 1).length,
        r = ((i * 100) / o).toFixed(0);
      return (
        Et(() => {
          try {
            const c = s
              .filter((l) => l.attempts)
              .map((l) => t(l.question._id.$oid, !!l.correct));
                            ...
                            [
                              ...
                              m("td", bn, [
                                ...
                                w(
                                  ...
                                  null,
                                  rt(
                                    Object.entries(f.question.optionsList),
                                    ([_, y]) => (
                                      g(),
                                      w("span", { key: _ }, [
                                        y.optionCorrect
  ...
  Ne = /* @__PURE__ */ z(Sn, [["__scopeId", "data-v-38adb08e"]]),
  xn = { class: "questions-left-header" },
  En = /* @__PURE__ */ M({
    __name: "MCQQuiz",
    setup(e) {
      const t = E(),
        ...
        return (
          ...
          w("main", null, [
            ...
            m(
              ...
              xn,
              " Question " +
                k(S(n).getAnsweredQuestionsNum()) +
                " out of " +
                k(S(n).quizStats.length),
              1,
            ),
            t.value
              ? (g(),
  ...
  Cn = /* @__PURE__ */ z(En, [["__scopeId", "data-v-edc7c7f1"]]),
  Dn = {
    key: 0,
    class: "time-left-header",
  },
  $n = { class: "questions-left-header" },
  kn = /* @__PURE__ */ M({
    __name: "MCQInfoPanel",
    props: {
      timeLeft: {
    ...
    setup(e) {
      ...
      return (s, o) => (
        ...
        w(
          ...
          [
            e.timeLeft
              ? (g(), w("h3", Dn, " Time left: " + k(n(e.timeLeft)), 1))
              : V("", !0),
            m(
              "h3",
              $n,
              " Question " +
                k(S(t).questionsStack.length) +
                " out of " +
                k(S(t).quizStats.length),
              1,
            ),
          ],
          64,
    ...
    setup(e) {
      ...
      const r = () => {
        ...
        d = () => {
          ...
          (o = window.setInterval(_, re)),
            (s = window.setTimeout(() => {}, t.timeLimit * re));
        },
        f = () => {
          var y;
          l();
          ...
          for (
            _(((y = n.value) == null ? void 0 : y._id.$oid) ?? "");
  ...
  On = /* @__PURE__ */ z(Qn, [["__scopeId", "data-v-4fd74e68"]]),
  Vn = ["id", "name", "value", "disabled"],
  Mn = ["for"],
  qn = {
    key: 0,
  ...
  Pn = /* @__PURE__ */ M({
    ...
    setup(e) {
      const { category: t, topics: n } = e,
        s = U(),
        o = (c) => (t === "course" ? c.toUpperCase() : c),
        i = Ht(() =>
          Object.entries(n)
            .map(([c, l]) => {
              const d = a(l, t),
                f = nn(s.allQs, l, t).length.toString();
        ...
        a = (c, l) => {
          ...
          if (!d[l] || ((y = d[l]) != null && y.includes(c))) return null;
          const f = JSON.parse(JSON.stringify(s.getselectedtags()));
          f[l].includes(c) || f[l].push(c);
          const _ = s.allQs;
          return Gt(_, f).length.toString();
        };
      return (c, l) => (
        g(),
        w("ul", null, [
          ...
          w(
            ...
            rt(
              i.value,
              ({ idx: d, num: f, topic: _, questionamount: y }) => (
                g(),
                w(
                  "li",
                  {
  ...
  In = /* @__PURE__ */ z(Pn, [["__scopeId", "data-v-43544b02"]]),
  Ln = {
    key: 0,
    class: "filter",
  },
  Rn = { class: "category-heading" },
  jn = /* @__PURE__ */ M({
  ...
  zn = /* @__PURE__ */ z(jn, [["__scopeId", "data-v-0ae43360"]]),
  Hn = { for: "optionName" },
  Fn = ["value"],
  Un = /* @__PURE__ */ M({
    __name: "DropDownbox",
    ...
    setup(e) {
      ...
      function s(o) {
        const i = o.target;
        i.value &&
          ((n.value = parseFloat(i.value) * 60), t.setTimeLimit(n.value));
      }
      return (o, i) => (
        g(),
        w(
  ...
  Gn = /* @__PURE__ */ z(Un, [["__scopeId", "data-v-5f3ae97a"]]),
  gt = (e) => (ce("data-v-c3d686ea"), (e = e()), le(), e),
  Bn = { class: "start-page-container" },
  Wn = /* @__PURE__ */ gt(() =>
    /* @__PURE__ */ m("h1", null, "VetCloud Smart Quiz", -1),
  ),
  Jn = { class: "quiz-config-container" },
  Yn = { class: "question-config-container" },
  Kn = { class: "tag-text" },
  Xn = { class: "question-number" },
  Zn = { class: "question-amount-container" },
  to = /* @__PURE__ */ gt(() =>
    /* @__PURE__ */ m(
      "label",
      { for: "question-amount" },
  ...
  no = /* @__PURE__ */ gt(() =>
    /* @__PURE__ */ m("label", { for: "mode-select" }, "Select mode:", -1),
  ),
  oo = /* @__PURE__ */ gt(() =>
    /* @__PURE__ */ m("option", { value: "Tutor" }, "Tutor", -1),
  ),
  io = /* @__PURE__ */ gt(() =>
    /* @__PURE__ */ m("option", { value: "Timed" }, "Timed", -1),
  ),
  ro = [oo, io],
  ao = 3e3,
  co = /* @__PURE__ */ M({
  ...
  lo = /* @__PURE__ */ z(co, [["__scopeId", "data-v-c3d686ea"]]),
  uo = (e) => e.trim().toLowerCase().replace("_", " "),
  po = (e) =>
    e.reduce((t, n) => {
      if (!n.includes(":")) return t;
      let [s, o] = n.split(":");
      return (
        ([s, o] = [s.trim().toLowerCase(), uo(o)]),
        t[s] ? (t[s] = [...t[s], o]) : (t[s] = [o]),
        t
      );
    }, {}),
      ...
      optionsList: [
        {
          ...
          attempts: 0,
          correctAttempts: 0,
          lastAttempted: /* @__PURE__ */ new Date(
            "2024-08-07T09:55:35.944+00:00",
          ),
        },
        {
...
function Lt(e) {
  const t = e.includes(":") && e.split(":").length === 2,
...
function mo(e) {
  return (
    L.isObject(e) &&
    L.isString(e.optionValue) &&
    (e.optionCorrect === void 0 || L.isBoolean(e.optionCorrect))
  );
}
function Ve(e) {
  return (
    L.isObject(e) &&
    L.isObject(e._id) && // Assuming _id is an object with $oid property
    L.isString(e._id.$oid) &&
    L.isString(e.statement) &&
    Oe(e.tags) && // Modified to ensure tags are always checked
    L.isArray(e.optionsList, mo) &&
    L.isString(e.link)
  );
}
function go(e) {
...
Total Questions Validated:`,
  ...
  const t = {
    ...
    n = e.reduce((s, o) => {
      if (!yt.isMCQuestion(o)) return { ...s, invalidQs: s.invalidQs + 1 };
      let { tags: i } = o;
      if (!i || (Array.isArray(i) && !i.length))
        return { ...s, noTags: s.noTags + 1 };
      const r = s.totalTags + i.length;
      if (!yt.validateTags(i, !0)) {
        const a = i.filter((l) => yt.isTag(l)),
          c = s.invalidTags + i.length - a.length;
...
function yo(e, t) {
  ...
  Ot(n, `Invalid Questions Received: %c${n} out of ${t}`),
    Ot(s, `Filtering out invalid tags: %c${s} out of ${i}`),
...
const wo = /* @__PURE__ */ M({
    ...
    setup(e) {
      ...
      ue(async () => {
        if (r) {
          const f = await (async () =>
            (await (await fetch(`${r}?level=${a.value}`)).json()).questions)();
          i.value = _o(f);
        } else i.value = vo();
        s.allQs = i.value;
        const l = De(i.value.map((d) => d.tags));
        s.setselectedTags(
      ...
      const c = ({ questionAmount: l, mode: d }) => {
        ...
        const _ = Gt(i.value, f),
          y = sn(l, _);
        (n.value = y.length),
          s.initialiseQuiz(y, d),
          d === "Timed" && s.setTimeLimit(l * s.timeLimit),
          (o.value = !0);
      };
      return (l, d) =>
        o.value && S(s).quizMode === "Tutor"
          ? (g(), H(Cn, { key: 0 }))
          : o.value && S(s).quizMode === "Timed"
            ? (g(), H(On, { key: 1 }))
            : (g(),
              H(lo, {
                key: 2,
...
function Eo(e, t = {}) {
  const n = ys();
  e.use(n),
    e.component("CrucibleComponent", wo),
    e.provide("$dataLink", t.dataLink || Ao),
    e.provide("$updateQAttemptCallback", t.updateQAttemptCallback || qe);
}
export {
