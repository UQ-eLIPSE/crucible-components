...
import { useQuizStore } from "../src/plugins/CruciblePlugin/store/QuizStore";
import DropDownbox from "@/plugins/CruciblePlugin/components/DropDownbox.vue"; // Ensure the import is correct
